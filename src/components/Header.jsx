        ...
        <Container>
          <div className='heading-wrap flex items-center justify-between'>
            ...
            <nav className={`heading-menu ${isMenu ? 'show-menu' : ''}`}>
              ...
              <ul className="lg:flex items-center">
                {navLinks.map((link, index) => (
                  <li key={index} className='d-block cursor-pointer'>
            ...
            <a
                ...
                className={` max-w-max text-sm lg:text-base border-none capitalize hover:transform hover:scale-[1.1] bg-[#080808] text-white rounded-lg font-bold !leading-[1] py-2 md:py-3 lg:py-4 px-5 md:px-6 lg:px-7 flex items-center gap-2`}
              >
                Resume
